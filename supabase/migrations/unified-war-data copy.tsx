...
//           });
//         }
//       // --- GET_CALLS: Lecture des appels actifs ---
//       case 'get_calls':
//         {
...
//   }
// }
// export async function syncUpdates(req) {
//   if (req.method === 'OPTIONS') return jsonResponse('ok');
//   try {
//     const { faction_id, since_timestamp } = await req.json();
//     if (!faction_id) return errorResponse('Missing faction_id', 400);
//     const supabase = getSupabaseClient();
//     const sinceTime = since_timestamp || new Date(Date.now() - 60000).toISOString();
//     const { data: updates } = await supabase.rpc('get_sync_updates', {
//       p_faction_id: parseInt(faction_id),
//       p_since: sinceTime
//     });
//     return jsonResponse({
